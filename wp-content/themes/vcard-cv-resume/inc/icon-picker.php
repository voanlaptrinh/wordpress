...
class Vcard_CV_Resume_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'vcard-cv-resume' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $vcard_cv_resume_font_awesome_icon_array = vcard_cv_resume_font_awesome_icon_array();
                    foreach ($vcard_cv_resume_font_awesome_icon_array as $vcard_cv_resume_font_awesome_icon) {
                            $icon_class = $this->value() == $vcard_cv_resume_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($vcard_cv_resume_font_awesome_icon).'"></i>
                            <span class="vcard-cv-resume-social-class">'.esc_attr($vcard_cv_resume_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function vcard_cv_resume_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'vcard-cv-resume-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'vcard_cv_resume_customizer_script' );

if(!function_exists('vcard_cv_resume_font_awesome_icon_array')){
    function vcard_cv_resume_font_awesome_icon_array(){
